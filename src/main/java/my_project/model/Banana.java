...
public class Banana extends GraphicalObject {
    ...
    public void update(double dt) {
        //TODO 03 Eine Banana soll von oben herab fallen. Sobald sie unten den Bildschirmrand berührt wird die Methode jumpBack() aufgerufen (siehe TODO 04).
        if (y < 1000){ y += speed*dt; } else {jumpBack(); player01.decreasePoints(1);}
        //if (checkAndHandleCollision(player01)) {jumpBack();}
    }

    //TODO 04 Lege eine Methode jumpBack() an, die bei Aufruf das Banana-Objekt oben am oberen Bildschirmrand an einer zufälligen x-Position positioniert.
